<?php /* Smarty version 2.6.27, created on 2013-08-11 12:17:51
...
unset($_smarty_tpl_vars);
 ...
 <?php echo smarty_function_help(array('id' => "mailing-name"), $this);?>
          ...
          <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "CRM/Campaign/Form/addCampaignToComponent.tpl", 'smarty_include_vars' => array('campaignTrClass' => "crm-mailing-group-form-block-campaign_id")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php if ($this->_tpl_vars['context'] == 'search'): ?>
        <tr class="crm-mailing-group-form-block-baseGroup">
            <td class="label"><?php echo $this->_tpl_vars['form']['baseGroup']['label']; ?>
</td>
            <td><?php echo $this->_tpl_vars['form']['baseGroup']['html']; ?>
 <?php echo smarty_function_help(array('id' => "base-group"), $this);?>
</td>
        </tr>
    <?php endif; ?>

    <tr class="crm-mailing-group-form-block-dedupeemail">
        <td class="label"><?php echo $this->_tpl_vars['form']['dedupe_email']['label']; ?>
</td>
        <td><?php echo $this->_tpl_vars['form']['dedupe_email']['html']; ?>
 <?php echo smarty_function_help(array('id' => "dedupe-email"), $this);?>
</td>
    </tr>
  </table>
