<?php /* Smarty version 2.6.27, created on 2013-08-14 13:50:21
         compiled from CRM/Contact/Form/Contact.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'crmURL', 'CRM/Contact/Form/Contact.tpl', 35, false),array('function', 'help', 'CRM/Contact/Form/Contact.tpl', 61, false),array('block', 'ts', 'CRM/Contact/Form/Contact.tpl', 35, false),array('modifier', 'crmAddClass', 'CRM/Contact/Form/Contact.tpl', 62, false),)), $this); ?>
...
<br />
              ...
              <?php if ($this->_tpl_vars['contactId']): ?>
                <td><label for="internal_identifier_display"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>CiviCRM ID<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php echo smarty_function_help(array('id' => "id-internal-id"), $this);?>
</label><br /><input id="internal_identifier_display" type="text" class="form-text eight" size="8" disabled="disabled" value="<?php echo $this->_tpl_vars['contactId']; ?>
"></td>
              <?php endif; ?>
            </tr>
          </table>
